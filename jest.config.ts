...
const config: Config = {
    ...
    // cacheDirectory: "/private/var/folders/8b/w4y_wyk16fs6vzs2qcq7cjyr0000gn/T/jest_dx",
    ...
    testPathIgnorePatterns: ['/node_modules/', '<rootDir>/tst-e2e', '<rootDir>/.claude/worktrees/'],
