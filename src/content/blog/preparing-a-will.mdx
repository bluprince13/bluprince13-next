...
Writing a will felt daunting before I started, but it turned out to be fairly simple. The companion guide took more effort, but this should make our executors' job easier. If you have been putting this off, I'd encourage you to book an appointment with a will writer. That in itself should provide sufficient momentum to finish it off.
