...
Updating a will involves the same process as writing one — professional help, witnesses, and storage. Hopefully, we will not need to update it for many years.
...
If you're putting this off, I'd encourage you to start by booking an appointment with a will writer. The hard part is getting started. Your loved ones will thank you for it.
