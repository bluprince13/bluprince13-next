...
description: A review of my goals for 2021 and new goals for 2022.
date: '2021-12-19'
categories:
 - life
...
year has been like and what I'd like to work towards in 2022.
...
<Table
 ...
 rows={[
  ...
  during a holiday and had to cut back on excercise. I've also gained about
  eight kilos in the last year, mostly from eating fast food.`
  },
  {
   res: 'Speed up at programming',
   status: 'Pass',
   comment: `I've got significantly faster at coding. I also completed a couple of
  designs at work that have boosted my self-confidence.`
  },
  {
   res: 'Become conversational at Spanish',
   status: 'Fail',
...
- Get faster at solving the simpler problems.
...
## 2. Become conversational at Spanish

A carryover goal. I started reading Harry Potter and the Philosopher's Stone in
Spanish this year. I enjoy this and I want to finish reading it by end of next
year. I also want to continue practicing Spanish with my teacher every week.

## 3. Create YouTube content

A carryover goal. I want to give YouTube video making a real shot in 2022. And
it's okay if I only make 1-2 videos and decide to give up after that. 🎬

## Conclusion

The older I get the more I want to spend time just relaxing, either by myself or
with my loved ones. So, it's important not to commit to doing too many things.
Goals 2 and 3 above feel easy enough to do as long as I'm committed. Goal 1 is a
bit demanding, but given coding is my only real hobby these days, it should also
be achievable. I'm looking forwards to 2022. 🥳
