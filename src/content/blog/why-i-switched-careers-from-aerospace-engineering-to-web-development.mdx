...
description: >
 I explain why engineering did not appeal to me, and explore how the industry
 has fallen behind in software development technology and culture.
date: '2020-11-09'
categories:
 - software
...
developer. Deciding to leave engineering and find a job in tech was difficult.
It was especially challenging for someone without the privilege of a British
passport nor any substantial previous experience in software development.
However, through a combination of perseverance and sheer luck, my dream came
true. In this article, I revisit my motivation for changing careers. I hope that
this will be useful to anyone in a similar position.
...
[Visual Basic](https://en.wikipedia.org/wiki/Visual_Basic), appealing.
...
part of a team rather than the solitary figure that I imagine most academics to
be.
...
[resident labour market test](https://www.gov.uk/uk-visa-sponsorship-employers/job-suitability).
...
- They lack essential software development tools, restricting developers from
  ...
  - Forget [CI/CD](https://www.redhat.com/en/topics/devops/what-is-ci-cd). There
    ...
    easily.
  - There is no easy way to spin up servers to deploy
    [web APIs](https://en.wikipedia.org/wiki/Web_API). Web APIs provide a
...
- The IT strategy is bonkers. A lot of buzz words like digital transformation,
  AI etc. are thrown about, but the leadership is not interested in tackling the
  fundamental problems as listed above.
...
Smart, determined employees, could deal with and solve these problems if it were
easy for them to effect change. However, that tends not to be the case.
...
with me, e.g.,
[Amazon's leadership principles](https://www.amazon.jobs/en/principles) or
Spotify's culture wonderfully explained in the video below.
...
It wasn't until October 9, 2019, that I got my first offer. Why did it take me a
whole year? How did I work towards my goal? I'll explore these in a
[follow-up article](/blog/how-i-switched-careers-from-aerospace-engineering-to-web-development).
Please let me know what you thought about this one or any questions you have in
the comments below.
