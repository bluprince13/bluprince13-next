...
described above also become useful material for my CV and interviews as well.
...
used. I could see that the big tech companies were advertising on LinkedIn and I
also liked LinkedIn's clean UI. I set up an email alert for new jobs that
...
and then another 10-20 hours studying/coding/applying for jobs at home. 😫
...
Good companies know what their core values are, and they make a conscious effort
to hire people who have a similar set of values. Employees reinforce these
values in each other on a day-to-day basis as well. Check out the values for the
following companies:
...
Luckily for me, most big tech companies, have values that I easily identify
with. I prepare answers to questions around those core values, drawing on my
...
I write down my answers in a git repo. This allows me to refine them over time
...
- **Task**. As part of this, my manager wanted me to draw network diagrams for
  every task I was leading. At first, I wasn't sure these diagrams would be all
  that value-adding, but I kept an open mind. I could have drawn up a few
  diagrams just to satisfy my manager, but I wanted to give it my best effort.
- **Action**. I found it difficult to draw the diagrams on paper / PowerPoint. I
  ...
  I was able to make high-quality network diagrams. I took the time to get them
  right by reviewing them with teammates.
- **Result**. I was able to plan and optimise even really complex activities,
  ...
  using my diagrams. In reviews with seniors, I could use my diagrams to better
  communicate, identify bottlenecks and ask for help. I got addicted to drawing
  network diagrams and planning. I even did presentations on yEd for the wider
  team.

---

For the really big companies, I looked at blogs or YouTube videos to help
prepare for their interviews. For example,
...
my answers with friends. This not only helps with flow and confidence, but good
friends will also tell you when your answer falls flat. 👎

I'd like to stress that preparing for the values interview isn't just about the
...
<Figure
 src="/blog/how-i-switched-careers-from-aerospace-engineering-to-web-development/assets/fizzbuzz.svg"
 caption="If only it were this easy. Fizzbuzz solution."
/>
...
I also learnt that I had to specifically prepare for it. Learning React, for
...
- Coding interview with 2 developers
- Values interview with 2 managers
- Problem-solving interview with 2 developers
...
culture. However, they felt that my lack of experience as part of a software
...
By October 2019, nearly 8 months after my first on-site with Spotify, I was
...
with Spotify and telephone/video interviews with other companies. On 9th
October, 2019, my recruiter called me and informed me that I had passed. It was,
...
to have had such amazing opportunities as an immigrant in the UK. However,
limiting the freedom of immigrants to change jobs, trapping them in a job, feels
inhumane to me. Something needs to change.
...
better results applying to companies directly.
...
them. Good luck on your job search! I hope you find something that makes you
happy. 😃
