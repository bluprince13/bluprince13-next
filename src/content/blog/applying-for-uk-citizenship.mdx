...
<Timeline
 items={[
  ...
  },
  {
   ...
   description: 'I took my current and previous passports.',
   iconName: 'fingerprint'
  },
  {
   marker: 'Day 60',
   title: 'Invitation to citizenship ceremony',
   description: 'Deadline to respond to the invitation was 20 days.',
   iconName: 'mail',
   color: 'warning'
  },
  {
...
<Table
 ...
 rows={[
  ...
  },
  {
   ...
   submission:
    `Scans of all pages for my current and previous passport
