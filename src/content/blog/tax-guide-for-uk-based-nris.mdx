...
<Alert severity="warning">
 This is not financial advice. I'm just a normal person googling to understand a fairly complex topic. Therefore, what I'm sharing with you may be incorrect. I have omitted a lot of detail and edge cases to keep it simple and digestible. This article will get out of date with time as laws evolve. Do not assume that all of the links that I share are correct or up-to-date either.
...
1. 2025-12-26 - Previously, the article said "Direct mutual fund investments are not available via NRE accounts".
This is not true and the statement has been removed. For example, [Zerodha](https://zerodha.com/open-account/nri/) says
a NRE PIS account can trade both equity and mutual funds. [IDFC bank](https://www.idfcfirst.bank.in/finfirst-blogs/nri/choosing-between-nre-nro-and-pis-accounts) also confirms this.
...
As of the 2024-2025 tax year, they can defer tax on up to £60,000 invested in the pension each financial year. They can also protect up to £20,000 per year of investments
...
wrappers, there is a paltry [Capital Gains tax-free allowance of £3000](https://www.gov.uk/capital-gains-tax/allowances). Any gains
over that will be taxed.

## Tax liability in India for NRIs

### If you reside outside of India for more than 182 days, then you're a Non-Resident Indian [NRI]

Generally, if you reside outside India for more than 182 days in one Financial Year (April-March),  you're treated as a Non-Resident Indian or NRI. There are exceptions which you can read about in [ICICI bank - Who qualifies to be an NRI, PIO, or OCI?](https://www.icicibank.com/nri-banking/nriedge/nri-articles/who-qualifies-to-be-an-nri-pio-or-oci).

### NRIs are not allowed to hold regular savings accounts, only NRO or NRE accounts
...
### NRO accounts are intended for domestic funds and NRE account for foreign funds
...
<ComparisonTable
 ...
 [
 {
    content: `Deposit foreign income only, which is converted and stored as INR`,
    status: 'neutral'
 },
 {
    content: 'Deposit foreign and domestic income as INR',
    status: 'good'
 }
 ],
 [
 ...
 [
 {
    content: (
 <Typography variant="inherit">
 Requires NRE PIS account as described in the next section.
 </Typography>
 ),
    status: 'bad'
 },
...
### NRI's income in India is taxable in India
...
<Figure
 src="/blog/tax-guide-for-uk-based-nris/assets/india-new-tax-regime-tax-rates-vs-income.png"
 size="l"
/>
...
and
[India: Notes](https://www.gov.uk/hmrc-internal-manuals/double-taxation-relief/dt9553). In the table below, we compare the tax rates for:
...
interest earned on your NRE and NRO accounts as well. The good news is that you can get tax relief on any tax you've already paid in India.
...
[Vance](https://www.vance.tech/uk) (£3 fee for £1000 at the time of writing). I have not used it to make any transfers yet. I'd appreciate it if you use my
...
#### Transfer abroad from NRE account via bank
...
#### Transfer abroad from NRO account involves more process

Transfer abroad from NRO account involves more process, but it is still possible. Current income (e.g. rent, dividends, interest) are freely repatriable.
Capital funds are subject to a USD 1 million limit and require tax compliance
documentation. See
...
## Do your own research and consult an advisor if appropriate
...
- UK
  - [HMRC customer forums](https://community.hmrc.gov.uk/customerforums/): Online forum where you can get answers from HMRC. They do seem to dodge some of the harder questions and point to a document or website though.
  - [Contact HMRC directly](https://www.gov.uk/government/organisations/hm-revenue-customs/contact?)
  - [r/UKPersonalFinance](https://www.reddit.com/r/UKPersonalFinance/): Online forum of people with an interest in UK personal finance
- India
  - [r/nri](https://www.reddit.com/r/nri/): Online forum dedicated to NRI matters
  - [r/indiatax](https://www.reddit.com/r/indiatax/): Online forum dedicated to tax in India

You could also hire an advisor or accountant, especially if you've got a lot of money at stake. Take care when selecting an accountant. Refer to [gov.uk - How to choose a tax agent](https://www.gov.uk/guidance/how-to-choose-a-tax-agent) and make sure your [advisor is qualified](https://www.monahans.co.uk/articles/qualified-accountant), e.g., is a Chartered Tax Advisor [CTA]. In India, you can verify that your accountant is chartered via [the Institute of Chartered Accountants of India: Trace a Member](https://traceamember.icai.org/).
