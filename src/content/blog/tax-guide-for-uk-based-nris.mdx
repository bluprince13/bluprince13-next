...
description:
 As a Non-Resident Indian living in the UK, I have been very confused about UK
...
I have been living in the UK since 2010 when I started my degree. Before that I
used to live in India. My family is also in India and I visit them once every
...
to India. Is there any financial benefit to doing so? This prompted me to do a
deep dive into the tax implications of keeping assets in India.

<Alert severity="warning">
  This is not financial advice. I'm just a normal person googling around to understand a fairly complex topic. Therefore, what I'm sharing with you may be incorrect. I have also left out a lot of detail and edge cases to keep it simple and digestible. However, I have provided links to all my sources so that you can explore further on your own.
...
## Tax wrappers in the UK can be used to tuck away up to £80,000 of income per year

Although the focus of this article will be income and assets in India, it's
worth having a baseline in mind to compare to - i.e. tax liabilities on UK
income/assets to the UK government.

The typical employed UK resident saves for their retirment in a
...
future albeit as long as they keep their assets in the UK. Outside of the tax
...
central bank and regulatory body responsible for regulation of the Indian
...
is set of rules regarding foreign money administered by RBI
...
accounts in India. When you become a NRI, you must convert any existing bank
  ...
  [
   {
    content: (
     <Typography variant="inherit">
      Funds may be transferred back to country of residence (also known as{' '}
    ...
    content: (
     <>
      <Typography variant="inherit" gutterBottom>
       ...
       Capital funds subject to USD 1 million limit and requires tax compliance
       documentation.
      </Typography>
      <Typography variant="inherit">
       See{' '}
...
Income tax in India is complex as you can imagine. ICICI bank has a really good
article
...
1. You have to pay tax if your level of income is higher that ₹3 lakh.
...
you've already paid TDS on the basis of the special tax provisions for NRIs,
then you don't have to file ITR. For more detail, see
...
than ₹3 lakh. For more detail see
...
You can also claim reduced tax on the basis of the
...
and could even face prosecution. If you had not previously declared your foreign
income, there is a
...
banks promise very low fees, but unscruplously give you a bad exchange rate,
...
NRO accounts involve more process, but it is still possible to transfer money
abroad. Current income (e.g. rent, dividends, interest) are freely repatriable.
Capital funds are subject to USD 1 million limit and requires tax compliance
documentation. See
...
to counterweigh all of the negatives, unless you really wanted to invest in shares of
...
India, you'd then need to asses whether it's worth transferring them to the UK
...
feedback and any corrections in the comments secion below. I would also love to
hear about your experience or investigations of this topic.
